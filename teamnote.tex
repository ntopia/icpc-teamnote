...
\subsection{BCC, Cut vertex, Bridge, Block-cut Tree}
\lstinputlisting[style=mycpp]{src/graph/bcc.cpp}

Block-cut Tree: 각 BCC 및 cut vertex가 block-cut tree의 vertex가 되며, BCC와 그 BCC에 속한 cut vertex 사이에 edge를 이어주면 된다.
