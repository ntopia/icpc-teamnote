...
\lstinputlisting[style=customcpp]{src/math/basic-arithmetic.cpp}
...
\lstinputlisting{src/graph/general-mincut-stoer-wagner.cpp}

\section{Geometry}

\subsection{Basic Operations}
\lstinputlisting{src/geometry/basic-operations.cpp}
